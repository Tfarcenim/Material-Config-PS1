...
public class MaterialConfigPS1 {
    ...
    static void configureServer() {
        ArmorMaterials.IRON.durabilityMultiplier = ModConfig.Server.IRON_ARMOR_DURABILITY_MULTIPLIER.get();
        ArmorMaterials.GOLD.durabilityMultiplier = ModConfig.Server.GOLD_ARMOR_DURABILITY_MULTIPLIER.get();
    }
